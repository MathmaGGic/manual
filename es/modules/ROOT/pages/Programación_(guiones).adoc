...
*image:18px-Bulbgraph.png[Note,title="Note",width=18,height=22] Aviso:* Para que los scripts se ejecuten es necesario cerrar la ventana propiedades (configuración).
